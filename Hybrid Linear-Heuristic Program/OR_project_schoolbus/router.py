...
class Router():
    ...
    def route_local_search(self):
        ...
        global_stops = list(self.stop_near_students.copy().keys())[1:]
        ...
        while len(global_students) != 0: 
            local_stops = global_stops.copy()
            next_stop = random.choice(local_stops)
            # base stop, always 0, by definition of file format
            current_stop = 0
...
if __name__ == '__main__':
    import router
    instance = router.Router('test_full.txt')
